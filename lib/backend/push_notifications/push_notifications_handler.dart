...
final parametersBuilderMap =
  ...
  'degDetails': (data) async => ParameterData(
        allParams: {
          'dogDetails': getParameter<DocumentReference>(data, 'dogDetails'),
          'userRecord': await getDocumentParameter<UsersRecord>(
              data, 'userRecord', UsersRecord.fromSnapshot),
        },
      ),
  ...
  'dogVerificationDetails': (data) async => ParameterData(
        allParams: {
          'dogDetails': getParameter<DocumentReference>(data, 'dogDetails'),
        },
      ),
  'statusVerification': (data) async => ParameterData(
        allParams: {
          'dogDetails': getParameter<DocumentReference>(data, 'dogDetails'),
        },
      ),
