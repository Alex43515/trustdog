...
class BottomLocationWidget extends StatefulWidget {
  ...
  final UserPostsRecord? location;
    ...
    return Align(
      ...
      child: Padding(
        ...
        child: StreamBuilder<UsersRecord>(
          stream: UsersRecord.getDocument(widget.location!.postUser!),
          builder: (context, snapshot) {
            ...
            final card7UsersRecord = snapshot.data!;
                            ...
                            child: Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: CachedNetworkImage(
                                  ...
                                  imageUrl: widget.location!.postPhoto,
                                  width: 200.0,
                                  height: 200.0,
                                  fit: BoxFit.cover,
                                ),
