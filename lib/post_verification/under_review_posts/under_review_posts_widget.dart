...
import 'under_review_posts_model.dart';
export 'under_review_posts_model.dart';

class UnderReviewPostsWidget extends StatefulWidget {
  const UnderReviewPostsWidget({super.key});

  static String routeName = 'underReviewPosts';
  static String routePath = '/underReviewPosts';

  @override
  State<UnderReviewPostsWidget> createState() => _UnderReviewPostsWidgetState();
}

class _UnderReviewPostsWidgetState extends State<UnderReviewPostsWidget> {
  late UnderReviewPostsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnderReviewPostsModel());
  }
