...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: AddChatUsersWidget.routeName,
          path: AddChatUsersWidget.routePath,
          asyncParams: {
        ...
        FFRoute(
          name: CreateGroupChatWidget.routeName,
          path: CreateGroupChatWidget.routePath,
          builder: (context, params) => CreateGroupChatWidget(),
        ),
        FFRoute(
          name: DegDetailsWidget.routeName,
          path: DegDetailsWidget.routePath,
          asyncParams: {
            'userRecord': getDoc(['users'], UsersRecord.fromSnapshot),
          },
          builder: (context, params) => DegDetailsWidget(
            dogDetails: params.getParam(
              'dogDetails',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          ...
          builder: (context, params) => params.isEmpty
              ? NavBarPage(initialPage: 'profilepage2')
              : Profilepage2Widget(),
        ),
        FFRoute(
        ...
        FFRoute(
          ...
          asyncParams: {
            'dogUser': getDoc(['dogs'], DogsRecord.fromSnapshot),
          },
          builder: (context, params) => DogProfileUpdateWidget(
            dogUser: params.getParam(
              'dogUser',
              ParamType.Document,
            ),
          ),
        ...
        FFRoute(
          name: DogVerificationDetailsWidget.routeName,
          path: DogVerificationDetailsWidget.routePath,
          builder: (context, params) => DogVerificationDetailsWidget(
            dogDetails: params.getParam(
              'dogDetails',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: StatusVerificationWidget.routeName,
          path: StatusVerificationWidget.routePath,
          builder: (context, params) => StatusVerificationWidget(
            dogDetails: params.getParam(
              'dogDetails',
              ParamType.DocumentReference,
              isList: false,
