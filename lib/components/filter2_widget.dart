...
import 'filter2_model.dart';
export 'filter2_model.dart';

class Filter2Widget extends StatefulWidget {
  const Filter2Widget({super.key});

  @override
  State<Filter2Widget> createState() => _Filter2WidgetState();
}

class _Filter2WidgetState extends State<Filter2Widget>
    with TickerProviderStateMixin {
  late Filter2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Filter2Model());
                                  ...
                                  Align(
                                    ...
                                    child: Container(
                                      ...
                                      child: custom_widgets.RangeSliderWidget(
                                        ...
                                        min: 0.0,
                                        max: 5000.0,
                                        start: FFAppState().priceMin,
                                        end: FFAppState().priceMax,
                                        divisions: 5000,
                                        ...
                                        valueFontSize: 15.0,
                                        isEnabled: true,
                                        onChange: (startValue, endValue) async {
                                          FFAppState().priceMin = startValue;
                                          FFAppState().priceMax = endValue;
                                          safeSetState(() {});
                                        },
                                      ),
                                    ),
                                    ...
                                    children: [
                                      Align(
                                        ...
                                        child: Container(
                                          ...
                                          height: 100.0,
                                          child:
                                              custom_widgets.RangeSliderWidget(
                                            width: 300.0,
                                            height: 100.0,
                                            min: 0.0,
                                            max: 120.0,
                                            start: FFAppState().ageMin,
                                            end: FFAppState().ageMax,
                                            divisions: 120,
                                            textColor:
                                                FlutterFlowTheme.of(context)
                                                    .secondary,
                                            ...
                                            isEnabled: true,
                                            onChange:
                                                (startValue, endValue) async {
                                              FFAppState().ageMin = startValue;
                                              FFAppState().ageMax = endValue;
                                              safeSetState(() {});
                                            },
                                          ),
                                        ),
                              ...
                              Expanded(
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    ...
                                    FFAppState().ageMin = 0.0;
                                    FFAppState().ageMax = 120.0;
