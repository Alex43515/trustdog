                                  ...
                                  onTap: () async {
                                    ...
                                    safeSetState(() {
                                      _model.isDataUploading_uploadDataNtw =
                                          false;
                                      _model.uploadedLocalFile_uploadDataNtw =
                                          FFUploadedFile(
                            ...
                            children: [
                              ...
                              if (_model.isPhoto == true)
                                InkWell(
                                  ...
                                  highlightColor: Colors.transparent,
                                  onTap: () async {
                                    _model.isPhoto = false;
                                    safeSetState(() {});
                                    safeSetState(() {
                                      _model.isDataUploading_uploadDataNtwVideo =
                                          false;
                                      _model.uploadedLocalFile_uploadDataNtwVideo =
                                          FFUploadedFile(
                                              bytes: Uint8List.fromList([]),
                                              originalFilename: '');
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Container(
                                  ...
                                  child: Visibility(
                                    visible: functions.hasUploadedMedia(_model
