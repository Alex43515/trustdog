                          ...
                          Align(
                            ...
                            child: AuthUserStreamWidget(
                              builder: (context) => Wrap(
                                ...
                                children: [
                                  if (valueOrDefault<bool>(
                                          currentUserDocument?.isVerifiedUser,
                                          false) ==
                                      true)
                                    Align(
                                      alignment: AlignmentDirectional(1.0, 1.0),
                          ...
                          AuthUserStreamWidget(
                            builder: (context) => RatingBarIndicator(
                              ...
                              rating: valueOrDefault<double>(
                                functions
                                    .averageRating((currentUserDocument?.rating
                                                .toList() ??
                                            [])
                                        .toList())
                                    ?.toDouble(),
                  ...
                  child: Row(
                    ...
                    children: [
                      FFButtonWidget(
                        onPressed: () async {
                          context
                              .pushNamed(CreateDogProfileNewWidget.routeName);
                        },
                        text: 'Add Dog',
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Padding(
                                                                      ...
                                                                      child:
                                                                          Stack(
                                                                        children: [
                                                                          if (listViewDogsRecord.isVerified ==
                                                                              false)
                                                                            InkWell(
                                                                              splashColor: Colors.transparent,
                                                                              focusColor: Colors.transparent,
                                                                    ...
                                                                    RichText(
                                                                      ...
                                                                      text:
                                                                        ...
                                                                        children: [
                                                                          TextSpan(
                                                                            text:
                                                                                listViewDogsRecord.dogPrice.toString(),
                                                                            style:
                                                                                TextStyle(),
                                                                          ),
                                                                          TextSpan(
