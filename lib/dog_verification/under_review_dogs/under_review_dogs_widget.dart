...
import 'under_review_dogs_model.dart';
export 'under_review_dogs_model.dart';

class UnderReviewDogsWidget extends StatefulWidget {
  const UnderReviewDogsWidget({super.key});

  static String routeName = 'underReviewDogs';
  static String routePath = '/underReviewDogs';

  @override
  State<UnderReviewDogsWidget> createState() => _UnderReviewDogsWidgetState();
}

class _UnderReviewDogsWidgetState extends State<UnderReviewDogsWidget> {
  late UnderReviewDogsModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnderReviewDogsModel());
  }
